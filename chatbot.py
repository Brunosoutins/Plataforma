...
class Config:
    ...
    API_KEY = "AIzaSyAKIfjP578QWjbvLc8TCI6KHJWsnjFl8Ag"
    ...
    AUDIO_FILE = "https://github.com/Brunosoutins/Plataforma/raw/refs/heads/main/assets/assets_audio_paloma_audio.mp3"
    AUDIO_DURATION = 7
    
    # Imagens
    IMG_PROFILE = "https://i.ibb.co/ks5CNrDn/IMG-9256.jpg"
    IMG_GALLERY = [
        "https://i.ibb.co/671WgWBt/IMG-9218.jpg",
    ...
    def show_offers_page():
        ...
        <div class="package-box package-premium">
            ...
            <div class="package-header">
                ...
                <div class="package-price" style="color: #9400d3;">R$ 37,00</div>
        ...
        <div class="package-box package-extreme">
            <div class="package-header">
                ...
                <div class="package-price" style="color: #ff0066;">R$ 57,00</div>
